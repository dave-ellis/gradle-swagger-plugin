...
import com.github.swagger.docgen.mustache.OutputTemplate;
...
public abstract class AbstractDocumentSource {
    ...
    public AbstractDocumentSource(String outputPath, String outputTpl, String swaggerOutput,
    ...
    protected File createFile(File dir, String outputResourcePath) throws IOException {
        ...
        logger.info("Creating file " + serviceFile.getAbsolutePath());
        return serviceFile;
    }
